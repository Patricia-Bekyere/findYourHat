...
class Field {
  ...
  playGame() {
    ...
    if (direction.toUpperCase() === 'N') {
      if (y === 0) {
        console.log('Please you cannot move any further North, Please choose another direction')
      } else {
        y -= 1
      }
    } else if (direction.toUpperCase() === 'S') {
        if (y >= this._field.length) {
          console.log('Please you cannot move any further to the South. Please choose another direction')
        } else {
          y +=1
        }
      } else if (direction.toUpperCase() === 'W') {
        if (x === 0) {
          console.log('Please you cannot move any further to the West. Please choose another direction')
        } else {
          x -= 1
        }
      } else if (direction.toUpperCase() === 'E') {
        if (x >= this._field[y].length) {
          console.log('Please you cannot move any further to the East. Please choose another direction')
        } else {
          x += 1
        }
      } else {
      ...
      if (this._hatAndHoles[y][x] === hat) {
        console.log('Please you found the hat You won!!!')
      } else if (this._hatAndHoles[y][x] === hole) {
        console.log('Please you fell in a hole. Game Over')
      } else {
